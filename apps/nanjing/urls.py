...
urlpatterns = patterns('',
    ...
    url(r'^(\w+)/proposal-show/(\d+)/$', views.proposal_show, name='proposal_show'),
    url(r'^(\w+)/proposal-seconded/(\d+)/$', views.proposal_seconded, name='proposal_seconded'),
    url(r'^(\w+)/proposal-discuss/(\d+)/$', views.proposal_discuss, name='proposal_discuss'),
    url(r'^(\w+)/proposal-vote/(\d+)/$', views.proposal_vote, name='proposal_vote'),
)
