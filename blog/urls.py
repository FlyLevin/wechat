...
urlpatterns = patterns('',
   ...
   # url(r'^keyword-update/(\d+)/$', myadmin.keyword_update, name='keyword_update'),
    ...
    url(r'proposal-delete/(\d+)/$', myadmin.proposal_delete, name='proposal_delete'),
    url(r'proposal-item-list/(\d+)/$', myadmin.proposal_item_list, name='proposal_item_list'),
    url(r'proposal-status/(\d+)/$', myadmin.proposal_status, name='proposal_status'),
    url(r'proposal-threshold/(\d+)/$', myadmin.proposal_threshold, name='proposal_threshold'),
    ...
    url(r'proposal-discussaction/$', myadmin.proposal_discuss_action, name='proposal_discuss_action'),
)
